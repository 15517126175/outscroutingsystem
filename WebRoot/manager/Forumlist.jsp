        ...
        <div id="contentwrapper" class="contentwrapper">
        	  ...
        	  <div class="contenttitle2">
            	...
            	<tr>
                	...
                	<td><a href="manager/toaddForum.jsp" class="btn btn_orange btn_link"><span>发表主题</span></a></td>
                </tr>
                </table>	
                </form>
                </div><!--tableoptions-->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><s:property value="forum_name" /></td>
                 			...
                 			<td class="center">
                            <a href="manager-showReply?forum_id=<s:property value="forum_id" />"  class="btn btn3 btn_search" ></a></td>
                        </tr>             			     
