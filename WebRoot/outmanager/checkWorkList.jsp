    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper">
        	  ...
        	  <div class="contenttitle2">
            	...
            	<form id="query" action="outmanager-checkWorkQuery" method="post">
            	<table>
            	<tr>
               ...
               <table cellpadding="0" cellspacing="0" border="0" class="stdtable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0">项目工时（天）</th>
                            <th class="head1">正常工时（天）</th>
                           	<th class="head0">请休假（天）</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td ><s:property value="employee_name" /></td>
                           	...
                           	<td><s:property value="normal_time" /></td>  
                           	<td><s:property value="holiday_time" /></td>  
                        </tr>
                    </tbody>
                    </s:iterator>
