                    ...
                    <tbody>
                     <s:iterator value="trainlist" status="status">
                        <tr>
                            ...
                            <td><s:if test="train_days==0">无</s:if><s:else><s:property value="train_days"/></s:else></td>
                            <td><s:property value="train_trainer"/></td>
                            <td><s:property value="train_place"/></td>
                            <td align="center"><s:if test="end_time==null">---</s:if><s:else><s:property value="end_time"/></s:else></td>
                            <td>
                            <button type="button" class="submit radius2"><a href="manager-totrain?train_id=<s:property value="train_id"/>">详情</a></button>                                                        
                                <s:if test="status==1" ><button type="button" class="submit radius2"><a href="manager-closetrain?train_id=<s:property value="train_id"/>" >关闭</a></button></s:if>                         
                            </td>
