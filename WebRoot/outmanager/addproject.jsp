    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper">
        	 ...
        	 <h3>添加外包项目</h3>
                    ...
                    <form class="stdform" id="addproject" enctype="multipart/form-data" action="outmanager-addOutProject" method="post" >
                    	
                        
        				 <br/>
        				 <p>
                        	<label>项目名称</label>
                            <span class="field"><input type="text"   id="project_name"  name="pro.project_name" class="smallinput" /></span>
                         
        				 </p>
        				  <p>
                        	<label>请选择项目类型</label>
                            <span class="field"><select  id="project_type" name="pro.proiect_type" class="uniformselect">
        				 ...
        				 <p>
                        	<label>项目来源</label>
                            <span class="field"><input type="text" id="boss_name"  name="pro.boss_name" class="smallinput" /></span>
        				 </p>
        				 <p>
        				<label>工作城市</label>
                        ...
                        <select type="text" id="city" name="city"  class="smallinput"/>
        				 ...
        				 <p>
                        	<label>工时</label>
                            <span class="field"><input type="text" id="woker_time"  name="pro.woker_time" class="smallinput" /></span>
        				 </p>
        				<p> 
        				 <label>开始时间</label>: &nbsp;<input type="text" name="datepickfrom" id="datepickfrom" />  </p>
        				<p> <label>结束时间</label>: &nbsp;<input type="text" name="datepickto" id="datepickto" /></p>
        				 <p>
                        	<label>上传公司合同</label>
                            <span class="field"><input type="file" id="boss_contract"  name="file1" class="smallinput" /></span>
        				 </p>
        				  <p>
                        	<label>上传员工合同</label>
                            <span class="field"><input type="file" id="employee_contract"  name="file1" class="smallinput" /></span>
        				 </p>
...
function form_submit(){
	...
	if (document.getElementById("project_name").value=="" || document.getElementById("boss_name").value=="")
	{
		alert("项目名称和项目来源不能为空！");
		return false;
