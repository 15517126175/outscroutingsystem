    ...
    <div class="centercontent">
        ...
        <div id="contentwrapper" class="contentwrapper">
        	 ...
        	 <h3>修改密码</h3>
                    ...
                    <form class="stdform" id="updatePwd" action="outmanager-updatePwd?user=${sessionScope.user}" method="post" >
        				...
        				<p class="stdformbutton">
                        	<button class="submit radius2" onclick="return form_submit()">确认</button>
